...
class Friend < ApplicationRecord
    ...
    validates :name_first, :name_last, presence: true, format: { with: /\A(?:[A-Za-z]+\.)?\s*[A-Za-z]+\s*(?:[A-Za-z]+\s*)*(?:[A-Za-z]+\s*)?\z/, message: "should contain a valid title, full name, and optional suffix" }
